...
<div class="max-width center-screen bg-white padding mt-5">
    ...
    ○ Banco de dados relacional - Escolha uma das opções abaixo:</br>    
    i. MySQL - https://www.mysql.com/downloads/</br>
    ii. MariaDB - https://mariadb.org/download/
    . GIT - https://git-scm.com/ - Versionador de código.</br>
    . DevExtreme https://js.devexpress.com/Documentation/ - Componentes JS
    (Utilizar a versão em jQuery
    ...
    configurações (caso existam), enfim tudo que é necessário para rodarmos
    seu projeto.</br>
    Observação: Faça o teste mesmo que não consiga entregar tudo, envie o que foi possível
    isso demonstra a força de vontade, que é um dos valores que buscamos para um integrante
    de nossa equipe.</br>
    <hr>
    <p>@KecoLima 2021</p>
</div>
